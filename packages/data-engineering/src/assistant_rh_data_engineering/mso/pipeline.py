...
from .config import IDENTITY, QNA_ENGINE_CONFIG, MsoPipelineConfig

__all__ = ["MsoPipeline"]


class MsoPipeline(MedallionPipeline):
    """Pipeline MSO: infra du socle, chunking QNA legacy (silver/gold)."""

    def __init__(self, config: Optional[MsoPipelineConfig] = None, **kwargs: Any):
        super().__init__(IDENTITY, config or MsoPipelineConfig(), **kwargs)
