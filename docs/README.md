...
Keep only canonical system references at this level:

- [Pipeline RAG](PIPELINE.md)
- [Schema database](DATABASE.md)

The rest is grouped by theme:

- [Architecture](architecture/) - backend boundary, ProConnect, and UI replacement notes.
- [Audit](audit/) - audit dossier and prioritization notes.
