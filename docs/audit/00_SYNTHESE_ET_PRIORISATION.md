...
- Issue [#102](https://github.com/DGAFP/assistant-rh/issues/102) (audit DGAFP/Légifrance) — voir addendum dans [LEGIFRANCE_DGAFP_AUTOMATION_PLAN.md](../ingestion/LEGIFRANCE_DGAFP_AUTOMATION_PLAN.md#issue-102--dgafpl%C3%A9gifrance-ingestion-audit-addendum-2026-06) : ingestion idempotente des embeddings, mode `--check-only` read-only, fail-fast `--strict-articles` sur `legifrance-bulk-dump`.
- Synthèse backend/ProConnect : [BACKEND_PROCONNECT_IMPLEMENTATION_RECOMMENDATION.md](../architecture/BACKEND_PROCONNECT_IMPLEMENTATION_RECOMMENDATION.md), intégrant les audits ouverts en PR [#135](https://github.com/DGAFP/assistant-rh/pull/135), [#136](https://github.com/DGAFP/assistant-rh/pull/136), [#137](https://github.com/DGAFP/assistant-rh/pull/137).
