...
| [06 — Audit approfondi code & schéma DB](06_AUDIT_CODE_ET_DB.md) | Anti-patterns mesurés : `chat_runs` à 154 colonnes (33 jamais écrites, dont les colonnes de diagnostic), index vectoriels manquants sur 3 des 4 tables de retrieval (scans séquentiels), absence de FK, tables fantômes Scalingo, erreurs « fail-open » silencieuses, et métriques critiques à remonter dans Scaleway/Cockpit. |
