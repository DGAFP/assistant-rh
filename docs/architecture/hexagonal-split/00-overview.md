...
> Documents du dossier : [décisions](06-decisions.md) · [architecture cible](01-target-architecture.md) · [contrat API](02-api-contract.md) · [diagrammes de séquence](03-sequence-diagrams.md) · [plan de migration](04-migration-plan.md) · [spike clients A2](07-openai-client-spike.md) · [audit d'isolation A5](07-runtime-isolation-audit.md) · [environnements](05-environments.md) · [LEDGER](LEDGER.md)
