...
| Fusion | RRF parcourt les sources triées ; score descendant puis clé canonique. La normalisation conserve le nombre exact de sources ayant participé, y compris la politique actuelle sur les sources vides/échouées. |
